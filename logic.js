class AudioController {
	constructor() {
		...
		this.clickSound = new Audio('assets/spear.mp3');
		this.flipSound = new Audio('assets/flip.mp3');
		this.victorySound = new Audio('assets/matching.mp3');
		this.matchedSound = new Audio('assets/mathed.mp3')
